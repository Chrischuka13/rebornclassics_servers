...
// ==========================================
router.put('/products/:handle', async (req, res) => {
    try {
        const updatedProduct = await Product.findOneAndUpdate({ handle: req.params.handle }, req.body, { new: true, runValidators: true });
        if (!updatedProduct) {
